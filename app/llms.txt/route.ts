...
export function GET() {
  const lines: string[] = [
    ...
    "",
    "Office: 19-11720 Stewart Crescent, Maple Ridge, BC. Phone 604-612-6209 (Lower Mainland), 250-391-0270 (Vancouver Island), 1-877-391-0270 (toll-free). Email office@squareonepaving.com.",
