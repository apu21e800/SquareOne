    ...
    <main className="bg-[#F6F4F0]">
      ...
      <section className="relative min-h-[88vh] flex items-end overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="absolute top-24 lg:top-28 left-6 lg:left-12 z-10 flex items-center gap-3">
          <span className="block w-1.5 h-1.5 rounded-full bg-[#0B5FB8] pulse-dot" style={{ boxShadow: "0 0 0 4px rgba(11,95,184,0.18)" }} />
          <span className="text-[10.5px] uppercase tracking-[0.32em] text-white/65 font-semibold">
            Square One Paving <span className="text-[#7FB3F2]">·</span> Vapor Blasting Division
          </span>
        </div>
          ...
          <div className="grid lg:grid-cols-[1fr_360px] gap-12 lg:gap-16 items-end">
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-7">
                <span className="block w-1.5 h-1.5 rounded-full bg-[#0B5FB8]" style={{ boxShadow: "0 0 0 4px rgba(11,95,184,0.18)" }} />
                <span className="text-[11px] uppercase tracking-[0.28em] text-[#7FB3F2] font-bold">Mobile Surface Restoration</span>
              ...
              <h1 className="text-white display-h" style={{ fontSize: "clamp(2.75rem, 7.5vw, 7rem)" }}>
                ...
                <span className="text-[#0B5FB8]" style={{ textShadow: "0 0 24px rgba(11,95,184,0.25)" }}>a surface.</span>
              </h1>
