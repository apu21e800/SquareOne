  ...
  return (
    <main className="bg-[#FAFAFA]">
      ...
      <section className="w-full py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <div className="text-center mb-16">
            <p className="text-[#D66620] text-xs uppercase tracking-[0.22em] font-semibold mb-3">The Process</p>
            <h2 className="text-4xl sm:text-5xl font-black text-[#333333]">How It Works</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step) => (
              <div key={step.num} className="relative">
                <div className="text-6xl font-black text-[#D66620]/10 leading-none mb-3">{step.num}</div>
                <div className="w-8 h-1 bg-[#D66620] rounded mb-4" />
      ...
      <section className="w-full py-24 bg-[#F2EFE9]">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <div className="mb-14">
            <p className="text-[#D66620] text-xs uppercase tracking-[0.22em] font-semibold mb-3">What We Remove</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {applications.map((app) => (
              <div key={app.title} className="bg-white rounded-xl p-6 border border-[#E8E4DE] hover:border-[#D66620]/30 hover:shadow-md transition-all">
                <span className="text-2xl text-[#D66620] block mb-3">{app.icon}</span>
      ...
      <section className="w-full py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 sm:px-8">
          <div className="text-center mb-12">
            <p className="text-[#D66620] text-xs uppercase tracking-[0.22em] font-semibold mb-3">The Details</p>
