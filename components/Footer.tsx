  ...
  return (
    <footer className="bg-[#111111] pb-8">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 0%, #F26430 20%, #FF8A5C 50%, #F26430 80%, transparent 100%)",
        }}
      />
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 pt-16">
          <div>
            <Link href="/" className="inline-flex items-center gap-3 mb-4">
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="text-white font-semibold text-base tracking-tight leading-none">Square One</span>
                <span className="text-white/55 font-medium text-[11px] uppercase tracking-[0.14em] leading-none">Paving</span>
              </div>
            </Link>
          ...
          <div>
            <h4 className="text-white font-semibold text-xs uppercase tracking-[0.15em] mb-5 pb-2 inline-block border-b-2 border-[#F26430]">Services</h4>
          ...
          <div>
            <h4 className="text-white font-semibold text-xs uppercase tracking-[0.15em] mb-5 pb-2 inline-block border-b-2 border-[#F26430]">Products</h4>
            <ul className="space-y-2.5">
              {[
          ...
          <div>
            <h4 className="text-white font-semibold text-xs uppercase tracking-[0.15em] mb-5 pb-2 inline-block border-b-2 border-[#F26430]">Contact</h4>
            <address className="not-italic space-y-3 text-white/60 text-sm leading-relaxed">
              <div className="pl-4 border-l-2 border-[#F26430]">
              ...
              <div className="pt-2">
                <a href="mailto:info@squareonepaving.ca" className="text-white hover:text-[#FF8A5C] transition-colors text-sm font-medium">info@squareonepaving.ca</a>
              </div>
