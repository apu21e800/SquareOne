...
/**
 * Field panorama — MOVE 2 of docs/SOUL-PASS.md. One full-bleed image band,
 * ~55vh, no parallax — just the ground, and a caption. (The vapour version
 * was reverted 31 Aug: the only vapour sources are low-res, and low-res
 * never runs full-bleed. Vapour lives in the services grid, the
 * applications rows, and its own pages.)
 */
const PANORAMA = {
