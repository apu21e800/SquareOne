  ...
  return (
    <section className="overflow-hidden">
      <div className="flex flex-col lg:flex-row">
        ...
        {/* Right: Content */}
        <div className="bg-[#F6F4F0] p-12 lg:p-20 flex flex-col justify-center lg:flex-1">
          <p className="text-[11px] uppercase tracking-[0.15em] text-[#C8601A] font-semibold mb-3">
            Premium Residential
          </p>
          <h2 className="text-[2.5rem] font-light text-[#111111] leading-tight tracking-[-0.02em] mb-4">
